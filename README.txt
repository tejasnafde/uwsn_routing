...
For running Unet audio on macOS Apple Silicon machine, you'll need to make sure that both
the Java and the PortAudio library are running in the same architecture.

More information:
https://blog.unetstack.net//blog/running-unet-audio-on-apple-silicon
